				...
				function t(n) {
					...
					this.gameStarted = !1, this.duringGameplay = !1, this.fpsStats = new ee(.01), this.lastInteractionTime = 0, this.lastGamePlayStop = 0, this.badEventsCounter = 0, this.asyncScreenshotLoader = function() {
						...
						return new Promise((function(n) {
							...
							console.log("Poki tried to display an ad lol");
						}))
		...
		var xr = function() {
			function t() {
				this.slotMap = new Map, this.totalRefreshNumber = {}, this.requestAd = function(t) {
					...
					z(kr(kr({}, i), {
						event: "request"
					})), fetch("https://api.poki.com/ads/houseads/display/".concat(t.width, "x").concat(t.height, "?game_id=").concat(E.gameID, "&site=").concat(E.siteID)).then((function(e) {
						return e.json()
					})).then((function(o) {
			...
			Or = function() {
				...
				return t.prototype.init = function(e) {
					...
					M.addEventListener(e.ready, (function() {
						...
						(null == n ? void 0 : n.HBVastUrl) && (t = null == n ? void 0 : n.HBVastUrl, R("https://a.poki.com/ads/vast-client-2.js", !0).then((function() {
